...
import 'package:fitbadmin/models/category_model/category_model.dart' as _i18;
import 'package:fitbadmin/models/item_model/item_model.dart' as _i16;
import 'package:fitbadmin/models/order_model/order_model.dart' as _i14;
import 'package:fitbadmin/models/school_model/school_model.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.EmailSenderPageStore>(() => _i11.EmailSenderPageStore());
    gh.factory<_i12.CategoriesPageStore>(() => _i12.CategoriesPageStore());
    gh.factory<_i13.OrderDetailPageStore>(() => _i13.OrderDetailPageStore(
          gh<_i14.OrderModel>(),
          gh<DateTime>(),
        ));
    gh.factory<_i15.EditItemPageStore>(() => _i15.EditItemPageStore(
          gh<_i16.ItemModel>(),
          gh<_i3.AddItemPageStore>(),
        ));
    gh.factory<_i17.EditCategoryPageStore>(() => _i17.EditCategoryPageStore(
          gh<_i18.CategoryModel>(),
          gh<_i9.AddCategoryPageStore>(),
        ));
    gh.factory<_i19.EditSchoolPageStore>(() => _i19.EditSchoolPageStore(
          gh<_i20.SchoolModel>(),
