                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'Email: ${pageStore.schoolsList[index - 1].email}'),
                              Text(
                          ...
                          Column(
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  if (await confirm(
                                    ...
                                    await pageStore.deactivateSchool(
                                        index - 1,
                                        pageStore
                                            .schoolsList[index - 1].isActive);
                                  }
                                },
                                child: Icon(
                              ...
                              GestureDetector(
                                  onTap: () {
                                    context.router.push(EditSchoolRoute(
                                        school:
                                            pageStore.schoolsList[index - 1]));
                                  },
