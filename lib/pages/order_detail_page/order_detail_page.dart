...
class OrderDetailPage extends StatefulWidget {
  ...
  const OrderDetailPage(
      {Key? key, required this.orderModel, required this.completed})
      : super(key: key);
...
class _OrderDetailPageState extends State<OrderDetailPage> {
  ...
  @override
  void initState() {
    pageStore = OrderDetailPageStore(widget.orderModel);
    pageStore.loadPage();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Observer(builder: (context) {
        ...
        print('KSISKSISS ' + widget.orderModel.items.length.toString());
        print('ORORRORO ' + pageStore.itemsList.length.toString());
        return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: pageStore.itemsList[index - 1].label ==
                                    'deleted'
                                ? Image.asset(
